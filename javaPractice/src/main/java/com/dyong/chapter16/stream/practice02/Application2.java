package com.dyong.chapter16.stream.practice02;

/* 온라인 주문 처리 시스템
 * 온라인 주문 시스템을 위한 프로그램을 작성하세요.
 * 주문은 `주문 ID`, `고객 이름`, `상품 목록`, `주문 금액`, `주문 상태`(예: "배송 중", "배송 완료") 정보를 가지고 있습니다.
 * 주어진 주문 리스트에서 다음 작업을 수행하세요.*/
